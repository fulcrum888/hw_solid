public class Main {
    ...
    public static void main(String[] args) {
        ...
        stock.loadToStock(dataLoader.loadProducts());
        ...
        do {
            ...
            switch (mainMenuItem) {
                case 1:
                    ...
                    break;
                case 2:
                    String[] productItems = stock.getAsArray();
                    ...
                    if (stockIndex != 0) {
                        shoppingCart.addToCart(stock.getProducts().get(stockIndex-1));
                    }
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    if (Orders.get().getOrders().size() > 0) {
                            ...
                            default:
                                ...
                                switch (orderActionItem) {
                                    case 0:
                                        break;
                                    case 1:
                                        if (Orders.get().getOrders().get(orderItem - 1).cancelOrder() == Status.CANCELED) {
                                        ...
                                        break;
                                    case 2:
                                        if (Orders.get().getOrders().get(orderItem - 1).payOrder() == Status.SEND) {
                                        ...
                                        break;
                                    case 3:
                                        Orders.get().getOrders().get(orderItem - 1).repeatOrder();
                                        System.out.println("Заказ создан");
                                        break;
                                    case 4:
                                        if (Orders.get().getOrders().get(orderItem - 1).returnOrder() == Status.RETURNED) {
                                            System.out.println("Заказ возвращен");
                                        } else {
                                            System.out.println("Нельзя вернуть неотправленный заказ");
                                        }

                                        System.out.println(Orders.get().getOrders().get(orderItem - 1).returnOrder());
                                        break;
                                }
                        }
                        break;
